...
const pr1 = new Promise((resolve, reject) => {
    setTimeout(() => {
      resolve("playersArray1");
    }, 2000);
  });
   
  const pr2 = new Promise((resolve, reject) => {
    setTimeout(() => {
      resolve("playersArray2");
    }, 1000);
  });

  pr1.then(result => console.log(result))
  .then().catch(err=> console.log(err))
  pr2.then(result => console.log(result)).catch(err=> console.log(err))
  //
   
//   pr1 // --> return new Promise {}
//     .then((players) =>  { // mapping out some properties to return a different array
...
//         })
//     })
//     .then( mappedPlayers => console.log(mappedPlayers))
